...
while is_running:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.button == 1:  # Left mouse button
                ...
                if not is_drawing_floor:
                    ...
                    end_pos = event.pos
                    floors.append([start_pos, end_pos])
                    is_drawing_floor = False
    ...
    # Draw ceiling
    pygame.draw.rect(screen, (50, 50, 50), (screen_width, 0, screen_width, screen_height // 2))

    # Draw floor
    pygame.draw.rect(screen, (100, 100, 100), (screen_width, screen_height // 2, screen_width, screen_height // 2))
